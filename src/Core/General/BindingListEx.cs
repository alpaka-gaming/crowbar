...
namespace Core.General
{
    public class BindingListEx<T> : BindingList<T>, IEquatable<BindingListEx<T>>
    {
        ...
        public new bool Equals(BindingListEx<T> otherList)
        {
            if (otherList == null)
                return false;
            bool result = false;
        ...
        public new void Sort(string nProperty)
        {
            _sort = FindPropertyDescriptor(nProperty);
            ApplySortCore(_sort, _dir);
        }

        public new void Sort(string nProperty, ListSortDirection direction)
        {
            _sort = FindPropertyDescriptor(nProperty);
            _dir = direction;
            ApplySortCore(_sort, _dir);
        ...
        protected PropertyDescriptor FindPropertyDescriptor(string nProperty)
        {
            ...
            PropertyDescriptor prop = null /* TODO Change to default(_) if this is not a reference type */;
            if (pdc != null)
        ...
        private PropertyDescriptor _sort = null /* TODO Change to default(_) if this is not a reference type */;
    }
}
