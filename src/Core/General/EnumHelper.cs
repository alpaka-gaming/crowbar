...
namespace Core.General
{
    public sealed class EnumHelper
    {
        ...
        {
            int index = -1;
            for (int pairIndex = 0; pairIndex <= list.Count - 1; pairIndex++)
            {
                KeyValuePair<System.Enum, string> pair = (KeyValuePair<Enum, string>)list[pairIndex];
        ...
        {
            KeyValuePair<System.Enum, string> pair = (KeyValuePair<Enum, string>)list[index];
            return pair.Key;
        }
