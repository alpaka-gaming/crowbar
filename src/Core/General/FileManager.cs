    ...
    public class FileManager
    {
        ...
        public static string ReadKeyValueToken(ref string buffer)
        {
            ...
            do
            {
                ...
                {
                    int pos;
                    pos = buffer.IndexOf(Strings.Chr(0xA), 1);
                    if (pos > -1)
        ...
        public static string ReadTextLine(BinaryReader inputFileReader)
        {
            ...
            try
            {
                while (true)
                {
                    ...
                    if (aChar == Strings.Chr(0) || aChar == Strings.Chr(0xA))
                        break;
                    line.Append(aChar);
                }
            }
        ...
        public static void ParsePath(object sender, ConvertEventArgs e)
        {
            if (e.DesiredType != typeof(string))
                return;
            if (System.Convert.ToString(e.Value) != "")
                e.Value = FileManager.GetCleanPath(System.Convert.ToString(e.Value), true);
        }
        ...
        public static void ParsePathFileName(object sender, ConvertEventArgs e)
        {
            if (e.DesiredType != typeof(string))
                return;
            if (System.Convert.ToString(e.Value) != "")
                e.Value = FileManager.GetCleanPathFileName(System.Convert.ToString(e.Value), true);
        }
        ...
        public static string GetTopFolderPath(string iPathFileName)
        {
            ...
            if (FileManager.GetPath(iPathFileName) == "")
                return "";
