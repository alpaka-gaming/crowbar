...
//             this.theDownloadOutputFolderOption = DownloadOutputPathOptions.DocumentsFolder;
...
//
//             this.theUnpackContainerType = ContainerType.VPK;
//             this.theUnpackPackagePathFolderOrFileName = "";
//             // Me.theUnpackOutputFolderOption = OutputFolderOptions.SubfolderName
//             this.theUnpackOutputFolderOption = UnpackOutputPathOptions.SameFolder;
...
//             this.theUnpackSearchField = UnpackSearchFieldOptions.Files;
//             this.theUnpackSearchText = "";
//             this.SetDefaultUnpackOptions();
//             this.theUnpackMode = InputOptions.File;
//
//             this.thePreviewMdlPathFileName = "";
//             this.thePreviewOverrideMdlVersion = SupportedMdlVersion.DoNotOverride;
...
//             this.theDecompileOutputFolderOption = DecompileOutputPathOptions.WorkFolder;
...
//             this.theDecompileMode = InputOptions.File;
...
//             this.theDecompileOverrideMdlVersion = SupportedMdlVersion.DoNotOverride;
//
...
//             this.theCompileOutputFolderOption = CompileOutputPathOptions.GameModelsFolder;
...
//             this.theCompileMode = InputOptions.File;
//
//             this.thePatchMdlPathFileName = "";
//             this.thePatchMode = InputOptions.File;
//
//             this.theViewMdlPathFileName = "";
//             this.theViewOverrideMdlVersion = SupportedMdlVersion.DoNotOverride;
//             this.theViewGameSetupSelectedIndex = 0;
//
//             this.thePackInputPathFileName = "";
//             // Me.theCompileOutputFolderIsChecked = True
//             // 'Me.theCompileOutputFolderOption = OutputFolderOptions.SubfolderName
//             this.thePackOutputFolderOption = PackOutputPathOptions.ParentFolder;
...
//             this.thePublishSearchField = PublishSearchFieldOptions.ID;
...
//         }
//
//         public BindingListExAutoSort<GameSetup.GameSetup> GameSetups
//         {
//             get
//             {
...
//             get
//             {
//                 return TheApp.GetProcessedPathFileName(this.theSteamAppPathFileName);
//             }
//         }
//
...
//                     this.theSetUpGamesGameSetupSelectedIndex = TheApp.Settings.GameSetups.Count - 1;
...
//         }
//
//         public DownloadOutputPathOptions DownloadOutputFolderOption
//         {
//             get
//             {
...
//         }
//
//         public UnpackOutputPathOptions UnpackOutputFolderOption
//         {
//             get
//             {
...
//                     this.theUnpackGameSetupSelectedIndex = TheApp.Settings.GameSetups.Count - 1;
...
//         }
//
//         public UnpackSearchFieldOptions UnpackSearchField
//         {
//             get
//             {
...
//         }
//
//         public InputOptions UnpackMode
//         {
//             get
//             {
...
//         }
//
//         public SupportedMdlVersion PreviewOverrideMdlVersion
//         {
//             get
//             {
...
//                     this.thePreviewGameSetupSelectedIndex = TheApp.Settings.GameSetups.Count - 1;
...
//         // End Property
//
//         public DecompileOutputPathOptions DecompileOutputFolderOption
//         {
//             get
//             {
...
//         }
//
//         public SupportedMdlVersion DecompileOverrideMdlVersion
//         {
//             get
//             {
...
//         }
//
//         public InputOptions DecompileMode
//         {
//             get
//             {
...
//         // End Property
//
//         public CompileOutputPathOptions CompileOutputFolderOption
//         {
//             get
//             {
...
//                     this.theCompileGameSetupSelectedIndex = TheApp.Settings.GameSetups.Count - 1;
...
//         }
//
//         public InputOptions CompileMode
//         {
//             get
//             {
...
//         }
//
//         public SupportedMdlVersion ViewOverrideMdlVersion
//         {
//             get
//             {
...
//                     this.theViewGameSetupSelectedIndex = TheApp.Settings.GameSetups.Count - 1;
...
//         }
//
//         public PackInputOptions PackMode
//         {
//             get
//             {
...
//         }
//
//         public PackOutputPathOptions PackOutputFolderOption
//         {
//             get
//             {
...
//                     this.thePackGameSetupSelectedIndex = TheApp.Settings.GameSetups.Count - 1;
...
//         }
//
//         public PublishSearchFieldOptions PublishSearchField
//         {
//             get
//             {
...
//         }
//
//         public ActionType OptionsAutoOpenVpkFileOption
//         {
//             get
//             {
...
//         }
//
//         public ActionType OptionsAutoOpenGmaFileOption
//         {
//             get
//             {
...
//         }
//
//         public ActionType OptionsAutoOpenMdlFileOption
//         {
//             get
//             {
...
//         }
//
//         public ActionType OptionsAutoOpenFolderOption
//         {
//             get
//             {
...
//         }
//
//         public ActionType OptionsDragAndDropVpkFileOption
//         {
//             get
//             {
...
//         }
//
//         public ActionType OptionsDragAndDropGmaFileOption
//         {
//             get
//             {
...
//         }
//
//         public ActionType OptionsDragAndDropMdlFileOption
//         {
//             get
//             {
...
//         }
//
//         public ActionType OptionsDragAndDropFolderOption
//         {
//             get
//             {
...
//         {
//             // NOTE: Call the properties so the NotifyPropertyChanged events are raised.
//             this.UnpackOutputSubfolderName = "unpacked " + My.Application.Info.Version.ToString(2);
//         }
//
...
//         {
//             // NOTE: Call the properties so the NotifyPropertyChanged events are raised.
//             this.DecompileOutputSubfolderName = "decompiled " + My.Application.Info.Version.ToString(2);
//         }
//
...
//         {
//             // NOTE: Call the properties so the NotifyPropertyChanged events are raised.
//             this.CompileOutputSubfolderName = "compiled " + My.Application.Info.Version.ToString(2);
//         }
//
...
//             this.OptionsAutoOpenVpkFileOption = ActionType.Unpack;
//             this.OptionsAutoOpenGmaFileIsChecked = true;
//             this.OptionsAutoOpenGmaFileOption = ActionType.Unpack;
...
//             this.OptionsAutoOpenMdlFileOption = ActionType.Decompile;
//
//             this.OptionsAutoOpenQcFileIsChecked = true;
//
//             this.OptionsAutoOpenFolderOption = ActionType.Decompile;
//         }
//
...
//             // NOTE: Call the properties so the NotifyPropertyChanged events are raised.
//
//             this.OptionsDragAndDropVpkFileOption = ActionType.Unpack;
//             this.OptionsDragAndDropGmaFileOption = ActionType.Unpack;
//
...
//             this.OptionsDragAndDropMdlFileOption = ActionType.Decompile;
//
//             this.OptionsDragAndDropFolderOption = ActionType.Decompile;
//         }
//
...
//         private DownloadOutputPathOptions theDownloadOutputFolderOption;
...
//         private UnpackSearchFieldOptions theUnpackSearchField;
...
//
//         private InputOptions theUnpackMode;
//         private bool theUnpackerIsRunning;
//
//         // Preview tab
//
//         private string thePreviewMdlPathFileName;
//         private SupportedMdlVersion thePreviewOverrideMdlVersion;
...
//         private DecompileOutputPathOptions theDecompileOutputFolderOption;
...
//
//         private SupportedMdlVersion theDecompileOverrideMdlVersion;
//
//         private InputOptions theDecompileMode;
//         private bool theDecompilerIsRunning;
//
//         // Compile tab
//
//         private string theCompileQcPathFileName;
//         private InputOptions theCompileMode;
//
//         private bool theCompileOutputFolderIsChecked;
//
//         // Private theCompileOutputFolderOption As OutputFolderOptions
//         private CompileOutputPathOptions theCompileOutputFolderOption;
...
//         // Patch tab
//
//         private InputOptions thePatchMode;
//         private string thePatchMdlPathFileName;
//
//         // View tab
//
//         private string theViewMdlPathFileName;
//         private SupportedMdlVersion theViewOverrideMdlVersion;
...
//         // Pack tab
//
//         private PackInputOptions thePackMode;
//         private string thePackInputPathFileName;
//
//         private PackOutputPathOptions thePackOutputFolderOption;
...
//         private PublishSearchFieldOptions thePublishSearchField;
//
...
//         private ActionType theOptionsAutoOpenVpkFileOption;
//         private bool theOptionsAutoOpenGmaFileIsChecked;
//         private ActionType theOptionsAutoOpenGmaFileOption;
...
//         private ActionType theOptionsAutoOpenMdlFileOption;
//
//         private bool theOptionsAutoOpenQcFileIsChecked;
//         // Private theOptionsAutoOpenQcFileOption As ActionType
//
//         private ActionType theOptionsAutoOpenFolderOption;
//
//         private ActionType theOptionsDragAndDropVpkFileOption;
//         private ActionType theOptionsDragAndDropGmaFileOption;
//
...
//         private ActionType theOptionsDragAndDropMdlFileOption;
//
//         // Private theOptionsDragAndDropQcFileOption As ActionType
//
//         private ActionType theOptionsDragAndDropFolderOption;
//
